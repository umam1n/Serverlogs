...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        categories_data = {
            ...
            'Emergency': ['Server Down', 'Network Outage', 'Power Failure', 'Security Breach'],
        }
        categories = []
        ...
        for _ in range(50):
            ...
            random_subcategory_name = random.choice(log_category.subcategories.all()).name
            dummy_activities = [random_subcategory_name, "Visual inspection."]
            ...
            log = ServerRoomAccessLog.objects.create(
                ...
                detailed_activities=dummy_activities,
                notes=f'Dummy request for {random_subcategory_name}.',
            ...
            if log_status == 'Completed':
                ...
                log.activity_report = f'Completed the {random_subcategory_name} task successfully.'
